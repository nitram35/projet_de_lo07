...
<div class="container">
    ...
    <form role="form" method='get' action='router.php'>
        <div class="form-group">
            ...
            <label for="id">Sélectionnez un individu de la famille : </label><select class="form-control" id="id"
                                                                                     name="id">
                <?PHP
            ...
            <label for="type">Sélectionnez un type d'évènement : </label><select class="form-control" id="type"
                                                                                 name="type">
