    ...
    <div class="container">
        ...
        <form role="form" method='get' action='router.php'>
            <div class="form-group">
                ...
                <!-- On choisit l'enfant -->
                <label for="id_enfant">Sélectionnez un enfant : </label><select class="form-control" id="id_enfant"
                                                                                name="id_enfant">
                    <?PHP
                ...
                <label for="id_parent">Sélectionnez un parent : </label><select class="form-control" id="id_parent"
                                                                                name="id_parent">
                    <?PHP
                    foreach ($results as $element) {
                        echo "<option value=" . $element->getId() . ">" . $element->getNom() . " : " . $element->getPrenom() . "</option>";
